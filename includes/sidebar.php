...
<div class="sidebar">
    ...
    <ul class="nav-links">
        <li><a href="/new-app/dashboard.php" class="<?= isActive('dashboard.php') ?>"><i>📊</i> Dashboard</a></li>
        ...
        <li><a href="/new-app/damage_report.php" class="<?= isActive('damage_report.php') ?>"><i>⚠️</i> Damage Reports</a></li>
